...
public class SelectParentElementCommand : ApplicationCommandBase
{
    ...
    public override string Title
    {
        get
        {
            return Localization.Resources.SelectParentElement;
        }
    }
    ...
    public override void Execute()
    {
        ...
        {
            editorWorkspace!.Editor.SelectParentElement();
        }
    }
}