// *********************************************************
// 
// ExpressiveWeb MoveElementLastCommand.cs
...
public class MoveElementLastCommand : ApplicationCommandBase
{
    public override string CommandName
    {
        get
        {
            return "MoveElementLast";
        }
    }
    ...
    public override string Title
    {
        get
        {
            return Resources.MoveElementLast;
        }
    }
    ...
    public override void Execute()
    {
        ...
        {
            editorWorkspace!.Editor.ChangeElementIndex(MoveRelativePosition.Last);
        }
    }
}