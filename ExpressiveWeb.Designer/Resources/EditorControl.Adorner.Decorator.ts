class AdornerDecorator extends HTMLElement {
    ...
    public startTextEditingMode(): void {
    ...
    public stopTextEditingMode(): void {
    ...
    private clearMarginsDecorations(): void {
    ...
    private drawMarginsDecorations(): void {
    ...
    private drawTextEditingDecorations(): void {
    ...
    private inflate(value: number): void {
